...
int main(){
{
    std::shared_ptr<int>ptr_1{new int{20}};
    *ptr_1=40;
    std::cout<<*ptr_1<<std::endl;
    std::cout<<"use_count    "<<ptr_1.use_count()<<std::endl;
    
    
    //Copying;
    std::shared_ptr<int>ptr_2=ptr_1;
    std::cout<<"The pointer to value "<<*ptr_2<<std::endl;
    *ptr_2=90;
    std::cout<<"Thdofjd"<<*ptr_2<<std::endl;
    std::cout<<"use_count  "<<ptr_1.use_count()<<std::endl;
    std::cout<<"use_count  "<<ptr_2.use_count()<<std::endl;
